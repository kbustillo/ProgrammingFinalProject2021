...
if __name__ == "__main__":
    ...
    v1 = time.time()   
    print("Using Panjer recursion (the itrative version) with Numba, the probability that S is equal to ", s0, " is : ", Dist1, ". Found in ", t1 - t0, " seconds using Numba.")
    print("-----------------------------------------------------------------------------------------------------------------------------------------")

    print("Using Panjer recursion (the itrative version) with Numba, the probability that S is equal to ", s1, " is : ", Dist2, ". Found in ", v1 - v0, " seconds using Numba.")
    
    #for i in range(s0 + 1, s1 + 1):
    #   AggDist.append(fSm(PS0, Lambda, i, a, b))
    #proba2 = sum(AggDist)  
    #t1 = time.time()   
    ...
    #print("The probability that S is larger than ", s1, " is : ", 1-proba2)
