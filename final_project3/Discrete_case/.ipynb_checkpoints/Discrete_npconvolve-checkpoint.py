...
if __name__ == "__main__":
    ...
    # Second method : the convolution method using np.convolve in convN_NP
    ...
    z = np.cumsum(y)
    t1 = time.time() 
    print("Finding the distribution of S using np.convolve when n = ",n2 ," took ", t1 - t0, " seconds.")
    proba1 = z[s0 + 1]
    proba2 = 1- z[s1 + 1]
    print("The probability that S is smaller than ", s0, " is : ", proba1)
    print("The probability that S is larger than ", s1, " is : ", proba2)
    ...
    z = np.cumsum(y)
    t1 = time.time() 
    print("Finding the distribution of S using np.convolve when n = ",n3 ," took ", t1 - t0, " seconds.")
    proba1 = z[s0 + 1]
    proba2 = 1- z[s1 + 1]
    print("The probability that S is smaller than ", s0, " is : ", proba1)
    print("The probability that S is larger than ", s1, " is : ", proba2)
    ...
    z = np.cumsum(y)
    t1 = time.time() 
    print("Finding the distribution of S using np.convolve when n = ",n4 ," took ", t1 - t0, " seconds.")
    proba1 = z[s0 + 1]
    proba2 = 1- z[s1 + 1]
    print("The probability that S is smaller than ", s0, " is : ", proba1)
    print("The probability that S is larger than ", s1, " is : ", proba2)
